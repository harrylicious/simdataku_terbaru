                    ...
                    <form action="<?= base_url('admin/usaha/save_data'); ?>" method="post">
                        <div class="row">
                            ...
                            <div class="col-sm-6 ">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="th_berdiri" name="th_berdiri" placeholder="Tahun Berdiri" min="1990" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="npwp_usaha" name="npwp_usaha" placeholder="No. NPWP Usaha">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>No. Izin</label>
                                    <input type="number" class="form-control" id="no_izin" name="no_izin" placeholder="No. Izin">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="npwp_pimpinan" name="npwp_pimpinan" placeholder="No. NPWP Pimpinan">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="alamat_pemilik" name="alamat_pemilik" placeholder="Alamat Pemilik Usaha" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Jalan</label>
                                                <input type="text" class="form-control" id="jalan_pemilik" name="jalan_pemilik" placeholder="Jalan">
                                            </div>
                                        </div>
                                </div>
                                ...
                                <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="kode_pos_pemilik" name="kode_pos_pemilik" placeholder="Kode Pos">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Desa/Kelurahan</label>
                                                <input type="text" class="form-control" id="desa_pemilik" name="desa_pemilik" placeholder="Desa" required>
                                            </div>
                                        </div>
                                </div>
                                ...
                                <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="kecamatan_pemilik" name="kecamatan_pemilik" placeholder="Kecamatan Pemilik" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                        ...
                        <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Merk Produk</label>
                                            <input type="text" class="form-control" id="merk_produk" name="merk_produk" placeholder="Merk Produk yang dimiliki" >
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="usaha_lain" name="usaha_lain" placeholder="Usaha Lain. Misal: Percetakan, Pengiklanan, Jasa dan sebagainya">
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="panel panel-danger">
                                <div class="panel-heading">INFO</div>
                                    <div class="panel-body">
                                            ...
                                            <a href="<?= base_url('admin/usaha/tambah/'.$_SESSION['idadmin']) ?>" class="btn btn-success"><i class="fa fa-plus"></i> Tambahkan</a>
                                    </div> 
                                </div>
