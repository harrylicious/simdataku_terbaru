              ...
              <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm "> 
                  ...
                  <tbody>
                    ...
                    foreach ($data as $row) : 
                      ...
                      <tr>
                        <td><?= $no++; ?></td>
                        <td><a href="<?= base_url('admin/usaha/lihat_data_by_relawan/').$row->id_user."?nama_relawan=".$row->nama_lengkap; ?>" class="btn btn-success"><?= strtoupper($row->level).": ".$row->nama_lengkap; ?></a></td>
