    ...
    <div class="col-md-12">
      <div class="card "> 
        <div class="card-header ">
          <h5 class="card-title"> DAFTAR USAHA <strong><?= urldecode(strtoupper($wilayah)); ?></strong></h5>
        </div>
        <div class="card-body ">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><a href="<?= base_url('komoditas/get_daftar_komoditas_perkabupaten/') . $row->kecamatan; ?>" class="btn btn-danger">Lihat Daftar</a></td>
                  </tr>
